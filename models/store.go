...
type Store interface {
	...
	GetTicksByProductId(productId, granularity string, limit int) ([]*Tick, error)
	GetLastTickByProductId(productId, granularity string) (*Tick, error)
	AddTicks(tbname string, ticks []*Tick) error
