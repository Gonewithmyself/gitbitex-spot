...
func (s *orderBook) saveOrder(logOffset, logSeq int64, orderId int64, newSize, price decimal.Decimal,
	side models.Side) *pushing.Level2Change {
...
func (s *redisSnapshotStore) publishDepthSnapshot(productId string, snapshot *OrderBookLevel2Snapshot) error {
